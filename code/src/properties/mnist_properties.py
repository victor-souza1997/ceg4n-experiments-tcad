...
def _main(
    ...
    loaders = mnist_dataloaders(test_batch_data=1, img_size=size)
...
if __name__ == "__main__":
    train_options = [
        # ((8, 8), [], "mnist_8x8_lenet_sigmoid"),
        ((8, 8), [], "mnist_8x8_lenet_relu"),
        # ((28, 28), [], "mnist_28x28_lenet_sigmoid"),
        ((28, 28), [], "mnist_28x28_lenet_relu"),
    ]
